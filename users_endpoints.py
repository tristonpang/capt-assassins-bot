...
def displayPage(token):
    ...
    return render_template("player-info.html", token = token, user_alive = user_alive, user_nick = user_nickname, user_name = user_name, task = task_desc, target = target_name)
